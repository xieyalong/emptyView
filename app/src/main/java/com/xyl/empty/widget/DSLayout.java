...
public class DSLayout extends FrameLayout{
    ...
    public DSLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLayoutId = typedArray.getResourceId(R.styleable.lib_pub_DSLayout_lib_pub_dsl_layout, R.layout.ds_layout);
        ...
        mResIdEmpty = typedArray.getResourceId(R.styleable.lib_pub_DSLayout_lib_pub_dsl_emptyDrawable, R.drawable.ds_empty_ic_no_data);
        mResIdNetError = typedArray.getResourceId(R.styleable.lib_pub_DSLayout_lib_pub_dsl_netErroDrawable, R.drawable.ds_empty_ic_network_err);
        typedArray.recycle();
        init(context);
    }
